...
class PrazoParcelaTest {
    ...
    void deveRejeitarPrazoAbaixoDoMinimo() {
        assertThatThrownBy(() -> PrazoParcela.meses(5))
    ...
    void deveRejeitarPrazoAcimaDoMaximo() {
        assertThatThrownBy(() -> PrazoParcela.meses(85))
                .isInstanceOf(DomainException.class);
    }
    ...
    void deveAceitarPrazoMinimo() {
        PrazoParcela prazo = PrazoParcela.meses(6);
    ...
    void deveAceitarPrazoMaximo() {
        PrazoParcela prazo = PrazoParcela.meses(84);
